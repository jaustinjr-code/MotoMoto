...
{
    class EventAccountVerificationService : IEventAccountVerificationService
    {

        private string? operation { get; set; }
        private EventAccountVerificationDataAccess? evntAccntVerifDataAccess;
        //private UserManagementManager EvntAcctVerifManager;
        private Dictionary<string, string>? userProfile { get; set; }

        public EventAccountVerificationService()
        {
            operation = null;
            evntAccntVerifDataAccess = null;
            userProfile = null;
        }
        public EventAccountVerificationService(string operation, Dictionary<string, string> userProfile)
        {
            this.operation = operation;
            this.userProfile = userProfile;
            this.evntAccntVerifDataAccess = new EventAccountVerificationDataAccess();
        ...
        public bool SqlGenerator()
        {
            ...
            // }
            this.evntAccntVerifDataAccess = new EventAccountVerificationDataAccess(query);
