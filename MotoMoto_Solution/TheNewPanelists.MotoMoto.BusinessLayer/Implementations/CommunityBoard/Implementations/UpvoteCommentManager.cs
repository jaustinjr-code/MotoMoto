// Validates if the user is allowed to upvote a comment
using TheNewPanelists.MotoMoto.ServiceLayer;
using TheNewPanelists.MotoMoto.Models;

namespace TheNewPanelists.MotoMoto.BusinessLayer
{
    public class UpvoteCommentManager : IInteractionManager
    {
        /// <summary>
        /// Empty Default Constructor
        /// </summary>
        public UpvoteCommentManager() { }
        ...
        public bool IsInteractionDetailsValid(IInteractionModel inputModel)
        {
            ...
            if (((UpvoteCommentModel)inputModel).postId > 0 &&
                ((UpvoteCommentModel)inputModel).contentId > 0) return true;
            return false;
        }
        ...
        {
            IContentInteractionService service = new UpvoteCommentInteractService(inputModel);
            IResponseModel response = ((UpvoteCommentInteractService)service).InteractContent();
